...
1. **刚装好 OpenClaw**：先看本教程 [快速上手](/openclaw/03-advanced/09-multi-platform-integration/)，保证「能对话、能定时」。
...
- **本教程主站**：[安装](/openclaw/appendix/A-command-reference/)

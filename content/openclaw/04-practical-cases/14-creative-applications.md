...
description: "OpenClaw创意应用"
slug: 14-creative-applications
...
```bash
# 克隆技能仓库
git clone https://github.com/你的用户名/你的skills仓库.git
...
```bash
npx skills add https://github.com/你的用户名/你的skills仓库 --skill bananapro-image-gen
```text
**验证安装：**
